...
## Project Structure
    ...
    ├── testapiautoconnect_104237  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_104237`
...
2. Clone this repo and `cd testapiautoconnect_104237`
